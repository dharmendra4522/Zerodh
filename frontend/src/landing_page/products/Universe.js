        ...
        <div className="container mt-5">
            <div className="row text-center">
                ...
                <div className="col-4 p-3 mt-5">
                    ...
                    <a href="#" style={{ textDecoration: "none" }}> <p className="text-small text-muted fs-6">Our asset management venture <br />
                ...
                <div className="col-4 p-3 mt-5 ">
                    ...
                    <a href="#" style={{ textDecoration: "none" }}><p className="text-small text-muted fs-6">Options trading platform that lets you <br />
